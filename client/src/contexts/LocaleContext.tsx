...
function buildTenantSubtitle(language: Language, brand: BrandInfo) {
  if (language === "fr") {
    return `Sourcés auprès de fournisseurs agréés, vendus par ${brand.name}`;
  }
  if (language === "ar") {
...
function getTenantTranslationOverrides(
  ...
  if (tenantKey === "bdo") {
    const bdoSubtitle =
      language === "fr"
        ? "Unités d'or d'investissement estampées • Lingots certifiés et scellés"
        : language === "ar"
          ? "وحدات ذهب استثماري مختومة • سبائك معتمدة ومختومة"
          : "Stamped investment gold units • Certified and sealed bullion pieces";
    return {
  ...
  if (tenantKey === "met") {
    return {
      "buyer.panel.retailNearby.title": "Materials Marketplace",
      "buyer.panel.retailNearby.subtitle": "Earth materials, plans, and contractor services.",
      "buyer.noProducts.titleGeneral": "No materials listed yet",
      "buyer.noProducts.titleGlobal": "No materials listed yet",
      "buyer.noProducts.desc.category": "No materials match this category yet. Try clearing filters.",
      "buyer.noProducts.desc.noSellers": "No suppliers are currently published.",
      "buyer.noProducts.desc.sellersNoProducts": "Suppliers exist, but no active materials are published.",
      "buyer.noProducts.desc.generic": "Browse materials inventory from verified suppliers.",
    };
  }
...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "sections.stamped.subtitle": "Retail units, sealed & certified",
    ...
    "product.sellerType.retailSeller": "Retail gold seller",
    ...
    "buyer.panel.retailGold.title": "Retail Gold",
  ...
  fr: {
    ...
    "sections.stamped.subtitle": "Unit\u00e9s de d\u00e9tail, scell\u00e9es & certifi\u00e9es",
    ...
    "common.continueBrowsing": "Continuer à parcourir",
    ...
    "common.selectLabel": "Sélectionner",
    ...
    "buyer.categories.scrollLeft": "Faire défiler les catégories vers la gauche",
    "buyer.categories.scrollRight": "Faire défiler les catégories vers la droite",
    ...
    "buyer.categories.scrollForMore": "Faites défiler pour plus de catégories.",
    ...
    "buyer.panel.retailGold.title": "Or au détail",
    ...
    "vault.signInToAccess": "Connectez-vous pour accéder à votre coffre d’or virtuel.",
    "vault.description": "Stocké dans votre coffre d’or virtuel (livraison maintenant ou plus tard).",
  ...
  ar: {
    ...
    "sections.stamped.subtitle": "وحدات تجزئة، مختومة ومعتمدة",
  ...
  "nav.account": "\u0627\u0644\u062d\u0633\u0627\u0628",
    ...
    "buyer.panel.retailGold.title": "\u0630\u0647\u0628 \u0628\u0627\u0644\u062a\u062c\u0632\u0626\u0629",
...
export function LocaleProvider({ children }: { children: ReactNode }) {
  ...
  const setLanguage = useCallback((lang: Language) => {
    ...
    setSource("manual");
    persistEffectiveLocale(lang, currency);
    persistManualLocale(lang, currency);
    document.documentElement.dir = lang === "ar" ? "rtl" : "ltr";
    document.documentElement.lang = lang;
    queryClient.invalidateQueries();
  }, [currency, persistEffectiveLocale, persistManualLocale]);

  const setCurrency = useCallback((curr: Currency) => {
    setCurrencyState(curr);
    setManualOverride(true);
    setSource("manual");
    persistEffectiveLocale(language, curr);
    persistManualLocale(language, curr);
  }, [language, persistEffectiveLocale, persistManualLocale]);
  ...
  const applyAutoLocaleFromCountry = useCallback((countryCode: string | null | undefined) => {
    ...
    queryClient.invalidateQueries();
  }, [manualOverride, persistEffectiveLocale]);
