    ...
    <div className="min-h-screen bg-[#080808] text-[#F7F2E8]">
      <header className="sticky top-0 z-30 border-b border-[#C99A36]/20 bg-[#080808]/92 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4">
          <a href="/" className="flex items-center gap-3" aria-label="AGOOJYÉ accueil">
            <img src="/tenants/agoojye/logo-icon.svg" alt="" className="h-9 w-9" />
            <span className="font-semibold tracking-[0.22em] text-[#F7F2E8]">AGOOJYÉ</span>
          </a>
      ...
      <footer className="border-t border-[#C99A36]/20 bg-[#050505]">
        <div className="mx-auto grid max-w-7xl gap-6 px-4 py-8 md:grid-cols-[1fr_auto]">
          <div>
            <p className="text-sm font-semibold tracking-[0.2em] text-[#E4C46A]">AGOOJYÉ</p>
    ...
    <section className="relative overflow-hidden bg-[#080808]">
      ...
      <div className="relative mx-auto grid min-h-[calc(100vh-74px)] max-w-7xl items-center gap-10 px-4 py-20 lg:grid-cols-[1.05fr_0.95fr]">
        <div>
          ...
          <h1 className="mt-5 text-6xl font-black leading-none tracking-normal text-[#F7F2E8] md:text-8xl">AGOOJYÉ</h1>
      ...
      <Band dark eyebrow="Vision" title="L'Afrique ne fera pas que consommer le futur. Elle le construira.">
        <div className="grid gap-8 lg:grid-cols-[1fr_1fr]">
          <p className="text-lg leading-8 text-[#D8CFBF]">
            AGOOJYÉ défend une mobilité électrique construite localement : assemblage, compétences industrielles, formation des jeunes, fabrication de pièces, logiciels embarqués, systèmes de transport propres et ambition de production depuis le Bénin.
          </p>
          <div className="grid gap-3">
...
export function AgoojyeHistoryPage() {
  return (
    <AgoojyeLayout active="/history">
      <Band dark eyebrow="Origine" title="AGOOJYÉ naît d'une ambition industrielle portée par Exportunity Machinery.">
...
export function AgoojyeTeamsPage() {
  ...
  return (
    <AgoojyeLayout active="/teams">
      <Band title="Équipes du projet AGOOJYÉ.">
        <TeamGrid teams={teams} />
      </Band>
    </AgoojyeLayout>
  );
...
export function AgoojyeContactPage() {
  return (
    <AgoojyeLayout active="/contact">
      <Band dark title="Entrer en contact avec AGOOJYÉ.">
...
function SponsorForm() {
  ...
  return (
    <form onSubmit={submit} className="grid gap-3 rounded-md border border-[#D9C79B] bg-white p-5">
      ...
      {mutation.isSuccess ? <p className="text-sm font-medium text-[#123C2F]">Demande enregistrée. L'équipe AGOOJYÉ pourra la suivre dans le CRM.</p> : null}
...
function ContactForm() {
  ...
  return (
    <form onSubmit={submit} className="grid gap-3 rounded-md border border-[#C99A36]/25 bg-[#171717] p-5">
      ...
      {mutation.isSuccess ? <p className="text-sm font-medium text-[#E4C46A]">Message enregistré dans le CRM AGOOJYÉ.</p> : null}
  ...
  return (
    <section className="bg-[#123C2F]">
      <div className="mx-auto flex max-w-7xl flex-col gap-5 px-4 py-12 md:flex-row md:items-center md:justify-between">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#E4C46A]">AGOOJYÉ</p>
