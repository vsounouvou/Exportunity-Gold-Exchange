...
const EMAIL_ALIASES = [
  ...
  "team@agoojye.com",
  "admin@agoojye.com",
  "engineering@agoojye.com",
  "software@agoojye.com",
  "design@agoojye.com",
  "media@agoojye.com",
  "sponsors@agoojye.com",
  "partners@agoojye.com",
  "investors@agoojye.com",
  "legal@agoojye.com",
  "press@agoojye.com",
] as const;
...
async function ensureAgoojyeSeed(tenantId: number) {
  ...
  await db
    ...
    .values({
      ...
      fromName: "AGOOJYÉ",
      fromEmail: "contact@agoojye.com",
      replyToEmail: "contact@agoojye.com",
      createdAt: now,
      updatedAt: now,
    })
    .onConflictDoNothing();
...
const resources = {
  ...
  "email-settings": {
    ...
    create: (tenantId: number, body: any) => ({
      ...
      fromEmail: normalizeText(body.fromEmail) || "contact@agoojye.com",
      replyToEmail: normalizeText(body.replyToEmail) || "contact@agoojye.com",
