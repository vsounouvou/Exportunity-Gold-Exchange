...
export const integrationCards = [
  ...
  },
  {
    ...
    copy: "Allows Aminata and Idriss to help manage customer messages, page activity, and campaign follow-up.",
    status: "Not connected",
    action: "Connect Facebook",
    fallback: "Facebook connection is not enabled yet in this environment.",
    security: "You can revoke access anytime.",
  },
  {
    id: "instagram",
    title: "Connect Instagram",
    copy: "Allows Aminata to prepare posts, track customer replies, and coordinate social selling.",
    status: "Not connected",
    action: "Connect Instagram",
    fallback: "Instagram connection is not enabled yet in this environment.",
    security: "You can revoke access anytime.",
  },
  {
    id: "payments",
    title: "Connect payments",
    copy: "Allows Nene to help track invoices, payment links, collections, revenue, and cashflow.",
    status: "Not connected",
    action: "Connect payments",
    fallback: "Payment collection is not enabled yet in this environment.",
    security: "You approve provider access and collection settings.",
  },
  {
    id: "team",
