...
const OVERRIDES: Record<string, Partial<RouteDef>> = {
  ...
  "/expert-clones": { title: "Expert Clones", group: "operations", icon: "Brain", order: 70 },
  ...
  "/sales": { title: "Sales", group: "trade", icon: "DollarSign", order: 90 },
  ...
  "/admin/agoojye/sponsor-categories": {
  ...
  "/admin/agoojye/pipeline-stages": {
    title: "Etapes pipeline",
    group: "operations",
    subgroup: "AGOOJIYE",
    icon: "ClipboardList",
    order: 156,
  },
  "/admin/agoojye/organizations": {
    title: "Organisations",
    group: "operations",
    subgroup: "AGOOJIYE",
    icon: "Building2",
  ...
  "/admin/seo": { title: "SEO Hub", group: "system", subgroup: "SEO", kind: "hub", icon: "Search", order: 10 },
  "/admin/website/seo": { title: "SEO Health", group: "system", subgroup: "SEO", icon: "Search", order: 20 },
  "/admin/website/seo-autopilot": { title: "SEO Autopilot", group: "system", subgroup: "SEO", icon: "Zap", order: 30 },
  "/admin/website/visits": { title: "Visits Intelligence", group: "system", subgroup: "SEO", icon: "BarChart3", order: 40 },
  ...
  "/admin/settings/developer": { title: "Developer Settings", group: "system", icon: "RefreshCw", order: 100, adminOnly: true },
  "/admin/settings/fx": {
    title: "FX Settings",
    group: "settings",
    subgroup: "Finance",
  ...
  "/admin/ux-audit": { title: "UX Audit", group: "system", icon: "Search", order: 120, adminOnly: true },
